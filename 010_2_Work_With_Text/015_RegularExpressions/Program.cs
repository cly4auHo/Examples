...
/// </summary>
namespace _015_RegularExpressions
{
    class Program
    {
        static void Main()
        {
            ...
            // Создаем экземпляр класса Regex и передаем в качестве 
            // аргумента конструктора шаблон.
            ...
            while (true)
            {
                ...
                // Метод IsMatch - сравнивает принимаемую в первом параметре 
                // строку с шаблоном. 
                // IsMatch - метод возвращающий bool. 
                // True - в случае, если шаблон соответсвует строке, 
